...
Report bugs at https://github.com/cruse1977/netbox-vrf-ext/issues.
...
NetBox VRF Extensions could always use more documentation, whether as part of the
official NetBox VRF Extensions docs, in docstrings, or even on the web in blog posts,
articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at https://github.com/cruse1977/netbox-vrf-ext/issues.
...
Ready to contribute? Here's how to set up `netbox-vrf-ext` for local development.

1. Fork the `netbox-vrf-ext` repo on GitHub.
2. Clone your fork locally

    ```
    $ git clone git@github.com:your_name_here/netbox-vrf-ext.git
    ```
...
3. The pull request should work for Python 3.10, 3.11, 3.12 Check
   https://github.com/cruse1977/netbox-vrf-ext/actions
